{{-- delete-category-modal.blade.php --}}
<div x-show="openDelete" 
    ...
    <div @click.away="openDelete = false" 
         class="bg-white w-full max-w-md p-6 rounded-2xl shadow-xl border border-slate-100 text-left transition-all">
        
        <h2 class="text-lg font-bold text-slate-900 mb-2">Excluir Categoria</h2>
        <p class="text-sm text-slate-500 mb-5">
            Tem certeza que deseja excluir a categoria <span class="font-semibold text-slate-800">"{{ $label }}"</span>? As transações vinculadas a ela não serão apagadas.
        </p>
